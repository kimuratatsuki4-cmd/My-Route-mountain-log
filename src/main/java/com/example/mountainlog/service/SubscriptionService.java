...
public class SubscriptionService {
    ...
    public Customer createUser(User user) throws Exception {
    ...
    // すでに稼働しているサブスクリプションのデフォルト支払い方法を更新する
    public void updateSubscriptionPaymentMethod(String customerId, String paymentMethodId) throws StripeException {
        List<Subscription> subscriptions = getSubscriptions(customerId);
    ...
    public PaymentMethod getDefaultPaymentMethod(String customerId) throws StripeException {
        ...
        // 顧客のデフォルト支払い方法が未設定の場合（初回Checkout時など）、サブスクリプションから取得する
    ...
    public String getDefaultPaymentMethodId(String customerId) throws StripeException {
        ...
        // 同様に、顧客に支払い方法がない場合はサブスクリプションから取得
        if (defaultPaymentMethodId == null) {
            List<Subscription> subscriptions = getSubscriptions(customerId);
            for (Subscription subscription : subscriptions) {
                if (subscription.getDefaultPaymentMethod() != null) {
    ...
    public com.stripe.model.checkout.Session createStripeSession(String priceId, String customerId, String successUrl,
